...
public class UserBean implements UserService {
    ...
    public void updateUser(User user) throws Exception {
        ...
        if (this.userDAO.existsById(id)) {
            ...
            throw new Exception("Erro ao atualizar usuário: usuário com id: " + id + ", não está contido no banco de dados");
        }
    }
    ...
    public void deleteUserById(long id) throws Exception {
        if (this.userDAO.existsById(id)) {
            ...
            throw new Exception("Erro ao deletar usuário: usuário com id: " + id + ", não está contido no banco de dados");
        }
    }
