...
public class EstoqueFacilController {
    ...
    @GetMapping("/admin/relatorio/lotesBaixa")
    ...
    @GetMapping("/admin/relatorio/lotesProxVencimento")
    ...
    @GetMapping("/admin/relatorioGeral")
    ...
    // Retorna lista de produtos indisponíveis
    @GetMapping("admin/produtosEmFalta")
